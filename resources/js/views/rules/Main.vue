<template>
    <div class="flex-auto w-full h-full box-border p-6 overflow-hidden flex flex-col relative">
        ...
        <div class="flex justify-between w-full h-full space-x-4">
            <div class="w-full h-full box-border overflow-auto flex flex-col bg-white pb-16">
                    ...
                    <tbody v-else class="bg-white">
                        ...
                        <template v-else>
                            <tr v-for="(item, i) in rules" :key="i">
                                ...
                                <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap capitalize">R{{ i + 1 }}</td>
                                <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap capitalize">{{ item.r1 }}</td>
                                <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap capitalize">{{ item.r2 }}</td>
                                <td class="px-3 py-4 border-b border-gray-200 whitespace-nowrap capitalize">{{ item.r3 }}</td>
                                ...
                                <!-- <td width="25px" class="px-3 py-4 border-b border-gray-200 whitespace-nowrap capitalize">
                                    <button class="text-sx text-gray-400 hover:text-blue-400">
                                    ...
                                    <button class="text-sx text-gray-400 hover:text-red-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- <div class="absolute bottom-0 right-0 left-0 box-border overflow-hidden px-6 text-sm">
                    <div v-if="pageInfo != null" class="w-full box-border flex items-center justify-between bg-white px-4 z-50 border-t border-gray-200">
    ...
    methods: {
        ...
        async uploadFile(){
            try{
                ...
                let res = await axios.post("rules/import", data, {
                    headers: {
